                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group form-animate-text" style="margin-top:15px !important;">
                                            <input type="text" name="code" value="{{ $code }}" placeholder=""
                                        ...
                                        <div class="form-group form-animate-text" style="margin-top:15px !important;">
                                            <input type="text" name="no_polisi" value="" placeholder=""
                                                class="form-control{{ $errors->has('no_polisi') ? ' is-invalid' : '' }}"
                                        ...
                                        <div class="form-group form-animate-text" style="margin-top:10px !important;">
                                            <select name="jenis_kendaraan" id="jenis_kendaraan"
                                                ...
                                                @foreach ($jenis_kendaraan as $datas)
                                                    <option value="{{ $datas->jenis_kendaraan }}">
                                                        {{ $datas->jenis_kendaraan }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-animate-text" style="margin-top:15px !important;">
                                            <input type="number" name="tarif" id="tarifs" value=""
                                                placeholder=""
                                                class="form-control{{ $errors->has('tarif') ? ' is-invalid' : '' }} text-center"
                                                readonly="">
                                            @if ($errors->has('tarif'))
                                                <span class="help-block">
                                        ...
                                        <div class="form-group form-animate-text" style="margin-top:10px !important;">
                                            <input type="text" name="tgl_masuk" value="{{ $automatic_date }}"
                                                placeholder=""
                                                class="form-control{{ $errors->has('tgl_masuk') ? ' is-invalid' : '' }} text-center"
                                                readonly="">
        ...
        <div class="col-md-12 col-sm-12 col-x-12" style="margin-top: 0px;">
            ...
            @if (session('message'))
                <div class="alert alert-success alert-dismissible"
                    style="margin-top: 4%;margin-right: 10px; position:fixed; top:0; right:0; width:250px;>
					<h3>Success <span class="fa
                    fa-check"></span></h3>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" style="margin-left:17%">
                                                <a href="/transaksi/editDataParkiranMasuk/{{ $datas->id }}"
                                                    class="btn btn-success"><span class="fa fa-pencil"></span></a>
                                                {{-- <a href="/transaksi/ParkirSelesai/{{ $datas->id }}" class="btn btn-primary">Selesai</a> --}}
                                                <a href="/transaksi/struk/{{ $datas->id }}"
                                                    class="btn btn-dark">Struk</a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
